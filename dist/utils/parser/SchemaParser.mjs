import { Token, DFA, Parser, FailedPredicateException, ParserATNSimulator, PredictionContextCache, RecognitionException, NoViableAltException, ATNDeserializer, ParserRuleContext } from 'antlr4';
...
class SchemaParser extends Parser {
    ...
    constructor(input) {
        super(input);
        this._interp = new ParserATNSimulator(this, SchemaParser._ATN, SchemaParser.DecisionsToDFA, new PredictionContextCache());
    }
    schema() {
...
SchemaParser.DecisionsToDFA = SchemaParser._ATN.decisionToState.map((ds, index) => new DFA(ds, index));
...
class UserTypeContext extends ParserRuleContext {
    constructor(parser, parent, invokingState) {
        super(parent, invokingState);
        this.parser = parser;
    }
...
export { ArrayContext, DimensionContext, PrimitiveTypeContext, SchemaContext, StructContext, TypeContext, UserTypeContext, SchemaParser as default };
